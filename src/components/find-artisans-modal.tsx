...
export default function FindArtisansModal({
  artisans,
  userAddress,
  onArtisanClick,
}: FindArtisansModalProps) {
    ...
    >
      ...
      <DialogContent className="min-w-5xl max-h-[90vh] overflow-hidden flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Discover skilled artisans in your area. Set your preferred distance
          ...
          <div className="border-b pb-6 mb-6">
            <div className="space-y-4 items-center justify-center flex flex-col">
              ...
              <Button
                ...
                className="w-fit self-center bg-blue-600 hover:bg-blue-700"
              >
                {isSearching ? (
                  <>
            ...
            {isSearching && (
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-gray-600">
                  Finding skilled professionals in your area
                </p>
              </div>
            )}
            ...
            {hasSearched && !isSearching && searchResults.length > 0 && (
              <div>
                <h3 className="text-lg font-semibold mb-4">
                  Found {searchResults.length} artisan
                  {searchResults.length !== 1 ? "s" : ""} within {kmRange[0]} km
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-full p-4">
                  {searchResults.map((artisan) => (
                    <Card
                      ...
                      className="group cursor-pointer border-none pt-0"
                    >
                      <div className="relative">
                        <img
                          src={
                            ...
                            `https://ui-avatars.com/api/?name=${
                              artisan.firstName || "/placeholder.svg"
                            }+${artisan.lastName}`
                          }
            ...
            {hasSearched && !isSearching && searchResults.length === 0 && (
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <p className="text-gray-600 text-center mb-6 max-w-md">
                  We couldn't find any artisans within {kmRange[0]} km of your
                  location. Try increasing the search radius or use the location
                  search on the artisans page.
                </p>
                <div className="flex gap-3">
                  <Button
                    variant="outline"
                    onClick={() => setKmRange([Math.min(50, kmRange[0] + 10)])}
                  >
                    Increase Range
                  </Button>
